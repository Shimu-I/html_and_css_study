![GitHub repo size](https://img.shields.io/github/repo-size/Shimu-I/html_and_css_study)
![GitHub last commit](https://img.shields.io/github/last-commit/shimu-i/html_and_css_study)
![Visitor Count](https://visitor-badge.laobi.icu/badge?page_id=shimu-i/html_and_css_study)

# My HTML and CSS Documentation
...
The features we will talk about in this lesson are:  
- **i. Responsive Design**  
- **ii. CSS Shorthand Properties** 
- **iii. Inheritance** 
- **iv. CSS Specificity**  
- **v. Semantic Elements** 
- **vi. Comments** 
...
[YouTube Home Page](/Project/preview.md)
...
|------------|----------------|-----------|--------------------|----------------|--------------------|
|“Studying the ‘HTML & CSS Full Course – Beginner to Pro’ (by SuperSimple.dev)”|
...
| Day-5, 6 (7, 8 nov, 2025) | 15) Position Absolute and Relative, 16) Finish the Project, 17) More CSS Features | 6h 44min | 0:0:0 | Lesson 15, 16, 17 | Satisfied |
---
